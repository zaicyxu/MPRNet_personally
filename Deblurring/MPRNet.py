...
##########################################################################
# Default: n_feat=96, scale_unetfeats=48, scale_orsnetfeats=32
class MPRNet(nn.Module):
    def __init__(self, in_c=3, out_c=3, n_feat=48, scale_unetfeats=24, scale_orsnetfeats=16, num_cab=8, kernel_size=3, reduction=4, bias=False):
